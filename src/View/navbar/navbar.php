            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header position-relative">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="logo">
                            <a href="index.php"><img src="<?= asset('mazer/dist/assets/compiled/svg/logo.svg') ?>" alt="Logo" srcset=""></a>
                        </div>
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item  ">
                            <a href="<?= base_url() ?>/menu" class='sidebar-link'>
                                <i class="bi bi-egg-fried"></i>
                                <span>Menu</span>
                            </a>
                        </li>
                        <li class="sidebar-item  ">
                            <a href="index.php?page=transaction" class='sidebar-link'>
                        ...
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu ">
                                <li class="submenu-item  ">
                                    <a href="index.php?page=odata" class="submenu-link">Order Data</a>
                                </li>
                                <li class="submenu-item  ">
                                    <a href="index.php?page=ohistory" class="submenu-link">Order History</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
                ...
                <div class="footer clearfix mb-0 text-muted">
                    ...
                    <div class="float-end">
                        <p>Crafted with <span class="text-danger"><i class="bi bi-heart-fill icon-mid"></i></span>
                            by <a href="https://github.com/rizalfdlh">Rizal Fadillah</a></p>
                    </div>
                </div>
            </footer>
        </div>
